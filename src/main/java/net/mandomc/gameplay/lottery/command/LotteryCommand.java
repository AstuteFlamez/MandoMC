package net.mandomc.gameplay.lottery.command;
...
import net.mandomc.gameplay.lottery.gui.LotteryGUI;
...
public class LotteryCommand implements CommandExecutor {
     ...
     */
    public LotteryCommand(GUIManager guiManager, LotteryConfig lotteryConfig) {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        guiManager.openGUI(new LotteryGUI(guiManager, lotteryConfig), target);
