...
public final class BountyShowcaseManager {
    ...
    public static void update() {
        ConfigurationSection section = BountyConfig.get().getConfigurationSection("bounty.showcase");
    ...
    private static String buildCountdown(OfflinePlayer target, long lastSeen) {
        ...
        long intervalMillis = Math.max(1, BountyConfig.getTrackingInterval()) * 1000L;
