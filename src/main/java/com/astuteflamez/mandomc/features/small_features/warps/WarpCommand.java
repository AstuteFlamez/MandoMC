package com.astuteflamez.mandomc.features.small_features.warps;
...
public class WarpCommand implements TabExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command command,
        ...
        double x = com.astuteflamez.mandomc.features.small_features.warps.WarpConfig.get().getDouble(path + ".x");
